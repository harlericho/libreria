    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content col-sm-10">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" title="Gaurdar" onclick="guardarEditorial()"><i class="fa fa-save"></i> Gaurdar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
            ...
            <div class="modal-body">
                <form role="form" id="formeliminareditorial" method="POST">
                    ...
                    <fieldset>
                        <center>
                        <div class="form-group col-sm-12">
                            <label for="disabledSelect"><h4>¿ Esta seguro que desea eliminar esta editorial ?</h4></label>
                        </div>
                        </center>
                    </fieldset>
                </form>
